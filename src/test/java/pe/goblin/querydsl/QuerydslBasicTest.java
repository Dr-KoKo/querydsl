...
import static pe.goblin.querydsl.entity.QTeam.*;
...
import pe.goblin.querydsl.dto.MemberDto;
import pe.goblin.querydsl.dto.QMemberDto;
import pe.goblin.querydsl.dto.UserDto;
...
public class QuerydslBasicTest {
	...
	public void findDtoByJPQL() {
		List<MemberDto> result = em.createQuery(
				"select new pe.goblin.querydsl.dto.MemberDto(m.username, m.age) from Member m", MemberDto.class)
			.getResultList();
	...
	public void dynamicQuery_BooleanBuilder() {
		...
		List<Member> result = searchMemberByCondition_1(usernameParam, ageParam);
		Assertions.assertThat(result.size()).isEqualTo(1);
	}

	private List<Member> searchMemberByCondition_1(String usernameParam, Integer ageParam) {
